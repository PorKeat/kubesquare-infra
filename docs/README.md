...
Welcome to the **Kubesquare** HA Kubernetes Cluster Documentation. This repository provides step-by-step guides for provisioning, configuring, and maintaining an enterprise-grade Kubernetes cluster based on official upstream standards.
...
* **HA Endpoint Provider**: [kube-vip](https://kube-vip.io/)
* **Container Network Interface (CNI)**: [Cilium v1.19 (eBPF-based)](https://cilium.io/)
...
* **Resource Optimization**: [Kubernetes Kubelet Resource Reservation](https://kubernetes.io/docs/tasks/administer-cluster/reserve-compute-resources/)
...
1. [**01 - VM Prerequisites & Base Setup**](file:///Users/alexkgm/Kubesquare/docs/01-prerequisites.md)
   * Swap deactivation, sysctl parameters, kernel modules (eBPF & bridge), and required storage daemons.
2. [**02 - Cluster Installation (KubeKey v4)**](file:///Users/alexkgm/Kubesquare/docs/02-cluster-install.md)
   * KubeKey setup, full configuration template (`config-sample.yaml`), and cluster provisioning steps.
...
* **kube-vip Docs**: [https://kube-vip.io/](https://kube-vip.io/)
